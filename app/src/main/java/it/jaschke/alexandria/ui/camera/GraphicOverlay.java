...
public class GraphicOverlay<T extends GraphicOverlay.Graphic> extends View {
    ...
    public T getGraphicAt(float rawX, float rawY) {
        synchronized (mLock) {
            float minX = -1;
            float minY = -1;
            ...
            for (T graphic : mGraphics) {
                graphicX = graphic.translateX(rawX);
                graphicY = graphic.translateY(rawY);
                ...
                if ((graphicX > 0) && (graphicY > 0)) {
                    if ((minX == -1) && (minY == -1)) {
                        ...
                        graphicAt = graphic;
                    } else if ((graphicX > rawX) && (minY > graphicY)) {
                        minX = graphicX;
                        minY = graphicY;
            ...
            return (graphicAt == null) ? mFirstGraphic : graphicAt;
        }
    }
